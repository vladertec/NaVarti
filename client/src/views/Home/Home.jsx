...
const Home = () => {
  const currentFeeItems = [
    ...
    },
    {
      ...
      title: "Б/у машини",
      text: "Підтримайте наш збір коштів на придбання бу машин на передову. Ваш внесок допоможе забезпечити військових транспортом для різноманітних потреб, включаючи транспортування поранених, вантажу, патрулювання, технічної підтримки та евакуаціїї. ",
      link: "https://3vm4ue3e.forms.app/untitled-form",
    },
    {
