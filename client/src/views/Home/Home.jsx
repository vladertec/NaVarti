...
const Home = () => {
  const currentFeeItems = [
    {
      ...
      title: "DJI Mavic 3T ",
      text: "Цей сучасний засіб оснащений тепловізором, дозволить військовим здійснювати моніторинг, розвідку та реагувати на небезпеку з висоти пташиного польоту. Допоможіть нам зібрати необхідні кошти для придбання цього важливого обладнання та підтримки наших військових.",
      link: "https://3vm4ue3e.forms.app/untitled-form",
    },
    {
      photoUrl: "./img/content/currentFee/plasticStretchers.png",
      title: "Пластикові ноші",
      text: "Підтримайте нашу кампанію збору коштів на пластикові ноші, щоб допомогти нашим військовим отримати необхідну медичну допомогу якнайшвидше та ефективно. За допомогою нош можна швидше та безпечніше переносити поранених на передові пункти медичної допомоги. Ваша пожертва може зробити різницю між життям та смертю для наших захисників.",
      link: "https://3vm4ue3e.forms.app/untitled-form",
    },
    {
  ...
  const currentReportItems = [
    ...
    },
    {
      ...
      text: "Успішна передача 135-му окремому батальйону територіальної оборони (135 ОБ ТРО) трьох навігаторів, чотирьох камер нічного бачення та 5 комплектів акумуляторів. Ці засоби навігації та спостереження є невід'ємною частиною нашої підтримки та допомагають військовим ефективно керувати ситуацією на передовій.",
