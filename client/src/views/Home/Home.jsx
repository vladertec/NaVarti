...
const Home = () => {
  ...
  const teamPositionItems = [
    ...
    },
    {
      ...
      position: "Директор",
      text: "На початку вторгнення будинок батьків Анастасії згорів, і багато її друзів вирушили захищати Україну. Перед вступом у роботу у фонді, вона вже допомагала військовим, забезпечуючи їх різними ресурсами. Також активно приєднувалася до благодійних заходів, показуючи велике бажання допомагати.",
    },
  ]
  ...
  const transferredThingsItems = [
    ...
    { name: "Камери ніч. бачення", quantity: 28, unit: "шт." },
    { name: "Банок тушонки", quantity: 300, unit: "шт." },
