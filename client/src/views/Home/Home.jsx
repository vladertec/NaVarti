...
const Home = () => {
  const currentFeeItems = [
    ...
    },
    {
      ...
      text: "Підтримайте нашу кампанію збору коштів на пластикові ноші, щоб допомогти нашим військовим отримати необхідну медичну допомогу якнайшвидше та ефективно.  За допомогою нош можна швидше та безпечніше переносити поранених на передові пункти медичної допомоги.  Ваша пожертва може зробити різницю між життям і смертю для наших захисників.",
      link: "https://3vm4ue3e.forms.app/untitled-form",
    },
    {
